...
public class LoadAsset : MonoBehaviour
{
    ...
    private void Awake()
    {
        assetBundlePath = Application.dataPath + "/OutputAssetBundleDir";
        //E:/Unity/Working/AssetWork/Assets/OutputAssetBundleDir
        assetBundleFileName = "OutputAssetBundle";
        //OutputAssetBundleDir
    }
    private void Start()
    {
    ...
    private IEnumerator LoadAssetsByWWW()
    {
        ...
        path += assetBundlePath + "/" + assetBundleFileName;
        //File:///E:/Unity/Working/AssetWork/Assets/OutputAssetBundleDir/OutputAssetBundle
       ...
       //获取加载依赖
        ...
        for (int i = 0; i < dependencies.Length; i++)
        {
            ...
            //File:///E:/Unity/Working/AssetWork/Assets/OutputAssetBundleDir/red
